...
function NavLink({
  ...
  return (
    <Link
      ...
      className={cn(
        buttonVariants({
          variant: checkActiveNav(href) ? 'primary-teal-50' : 'ghost',
          size: 'sm',
  ...
  return (
    <Collapsible defaultOpen={isChildActive}>
      <CollapsibleTrigger
        className={cn(
          buttonVariants({
            ...
            size: 'sm',
            className:
              'bg-transparent text-[#2A8F9B] shadow-none hover:bg-transparent hover:text-[#2A8F9B]/90 focus:bg-transparent focus:text-[#2A8F9B]/90',
          }),
      ...
      <CollapsibleContent className='collapsibleDropdown' asChild>
        <ul>
          {sub!.map((sublink) => (
            <li key={sublink.title} className='px-6 py-1'>
